...
def parse_args():
    ...
    # general
    parser.add_argument('--cfg', type=str, required=False,default='experiments/coco/inference_demo_coco.yaml')
    parser.add_argument('--videoFile', type=str, required=False,default='test/test_video.mp4')
